...
tree_path = "/gpfs/ysm/project/kleinstein/mw957/repos/spectral-tree-inference/data/binary_tree_512.newick"
...
perf_metrics.to_csv("/gpfs/ysm/project/kleinstein/mw957/repos/spec_tree/script/binary_angle_512.csv")
